...
const games = [
    {
        ...
        description: 'A competitive tile-based tabletop card game of puzzling strategy. Slip into a world of tiles and tentacles! Flip tiles below to transform the board! Cast spells from a deck of devious magic to claim your victory!.',
